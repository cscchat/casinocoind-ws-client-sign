 ...
 * `casinocoind-ws-client` object should be here.
 */
...
new CasinocoindWsClientSign(Transaction, SeedOrKeypair).then((SignedTransaction) => {
  /**
   * Signed :D Now submit Airgapped, or using https://www.npmjs.com/package/casinocoind-ws-client
